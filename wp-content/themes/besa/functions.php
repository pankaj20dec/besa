...
function wp_bootstrap_footer_nav() {
  // Display the WordPress menu if available
  wp_nav_menu( 
    array( 
      'menu' => 'main_nav', /* menu name */
      ...
      'container' => 'false', /* container class */
      'fallback_cb' => 'wp_bootstrap_footer_nav_fallback', /* menu fallback */
      'walker' => new Bootstrap_walker()
    )
  );
}
...
add_image_size( 'wpbs-featured-home', 1079, 479, true);
...
if( !function_exists("wp_bootstrap_theme_styles") ) {  
    function wp_bootstrap_theme_styles() { 
        ...
        // For child themes
        wp_register_style( 'wpbs-genericons', get_template_directory_uri() . '/css/genericons.css', array() );
        wp_register_style( 'wpbs-light-box', get_template_directory_uri() . '/css/lightbox.css', array() );
        wp_enqueue_style( 'wpbs-light-box' );
		wp_enqueue_style( 'wpbs-genericons' );
		
        wp_register_style( 'wpbs-style', get_stylesheet_directory_uri() . '/style.css', array(), '1.0', 'all' );
        wp_enqueue_style( 'wpbs-style' );
		wp_register_style( 'wpbs-media', get_template_directory_uri() . '/css/media.css', array() );
		
		wp_enqueue_style( 'wpbs-media' );
    }
}
...
// Set UI labels for Custom Post Type
	$labels = array(
		'name'                => _x( 'Portfolio', 'Post Type General Name', 'Besa' ),
		'singular_name'       => _x( 'Portfolio', 'Post Type Singular Name', 'Besa' ),
		'menu_name'           => __( 'Portfolio', 'Besa' ),
		'parent_item_colon'   => __( 'Parent Portfolio', 'Besa' ),
		'all_items'           => __( 'All Portfolio', 'Besa' ),
		'view_item'           => __( 'View Portfolio', 'Besa' ),
		'add_new_item'        => __( 'Add New Portfolio', 'Besa' ),
		'add_new'             => __( 'Add New', 'Besa' ),
		'edit_item'           => __( 'Edit Portfolio', 'Besa' ),
		'update_item'         => __( 'Update Portfolio', 'Besa' ),
		'search_items'        => __( 'Search Portfolio', 'Besa' ),
		'not_found'           => __( 'Not Found', 'Besa' ),
		'not_found_in_trash'  => __( 'Not found in Trash', 'Besa' ),
	);
	
// Set other options for Custom Post Type
	
	$args = array(
		'label'               => __( 'portfolio', 'Besa' ),
		'description'         => __( 'Movie news and reviews', 'Besa' ),
		'labels'              => $labels,
...
// Set UI labels for Custom Post Type
	$labels = array(
		'name'                => _x( 'Testimonial', 'Post Type General Name', 'Besa' ),
		'singular_name'       => _x( 'Testimonial', 'Post Type Singular Name', 'Besa' ),
		'menu_name'           => __( 'Testimonial', 'Besa' ),
		'parent_item_colon'   => __( 'Parent Testimonial', 'Besa' ),
		'all_items'           => __( 'All Testimonial', 'Besa' ),
		'view_item'           => __( 'View Testimonial', 'Besa' ),
		'add_new_item'        => __( 'Add New Testimonial', 'Besa' ),
		'add_new'             => __( 'Add New', 'Besa' ),
		'edit_item'           => __( 'Edit Testimonial', 'Besa' ),
		'update_item'         => __( 'Update Testimonial', 'Besa' ),
		'search_items'        => __( 'Search Testimonial', 'Besa' ),
		'not_found'           => __( 'Not Found', 'Besa' ),
		'not_found_in_trash'  => __( 'Not found in Trash', 'Besa' ),
	);
